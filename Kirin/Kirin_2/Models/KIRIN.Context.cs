...
public partial class KIRINEntities : DbContext
{
    public KIRINEntities()
        : base("name=KIRINEntities")
    {
    ...
    [DbFunction("KIRINEntities", "SplitString")]
    public virtual IQueryable<string> SplitString(string sString, string cDelimiter)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<string>("[KIRINEntities].[SplitString](@sString, @cDelimiter)", sStringParameter, cDelimiterParameter);
    }
    ...
    public virtual int GetStackedDiversityEthnicityData(string schoolID, string subjectID)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GetStackedDiversityEthnicityData", schoolIDParameter, subjectIDParameter);
    }
